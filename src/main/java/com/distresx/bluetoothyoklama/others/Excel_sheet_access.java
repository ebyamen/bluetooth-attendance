...
public class Excel_sheet_access
{
    ...
    public static void readExcelFile(Context context, Uri uri,String BatchID,String Subject,String SubjectCode,int Batch, int Semester,String Stream,String Section,String Group)
    {
        ...
        try
        {
            progress.setTitle("Ayarlanıyor");
            progress.setMessage("Sınıf Ayarlanırken Lütfen Bekleyiniz!");
    ...
    public static boolean saveExcelFile(final Context context, final String fileName, String batchID)
    {
        ...
        try
        {
            progress.setTitle("Dışa Aktarılıyor");
            progress.setMessage("Excel Sayfası oluştururken lütfen bekleyiniz");
            progress.setCancelable(false);
            progress.show();
            ...
            try {
                ...
                builder.setMessage("File Exported in direcory-\n\n"+file+"\n\nView it?")
                        ...
                        .setNeutralButton("Email", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                emailIntent .putExtra(Intent.EXTRA_SUBJECT, "Öğrenci Bilgileri Dışa Aktarıldı!");
                                context.startActivity(Intent.createChooser(emailIntent , "Mail gönder..."));
                            }
                        })
                ...
                Log.w("FileUtils", "Yazma Başarısız " + file, e);
            } catch (Exception e) {
                Log.w("FileUtils", "Kaydetme Başarısız", e);
            } finally {
                try {
                    if (null != os)
                        os.close();
    ...
    public static boolean saveExcelFile(final Context context, final String fileName, String batchID,Date fromDate, Date toDate)
    {
        ...
        {
            progress.setTitle("Dışa Aktarılıyor");
            progress.setMessage("Excel Dosyası Dışa Aktarılırken Lütfen Bekleyiniz ");
            progress.setCancelable(false);
            progress.show();
            ...
            try {
                ...
                final Context cx = context;
                AlertDialog.Builder builder = new AlertDialog.Builder(context);
                builder.setMessage("Dosya Dizine Aktarıldı-\n\n"+file+"\n\nGörüntüle?")
                        .setCancelable(false)
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id)
                            {
                                ...
                                {
                                    Toast.makeText(context,"Excel Sayfalarını açmak için yüklü Uygulama yok",Toast.LENGTH_LONG).show();
                                }
                        ...
                        .setNeutralButton("Email", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                emailIntent .setType("vnd.android.cursor.dir/email");
                                emailIntent .putExtra(Intent.EXTRA_STREAM, path);
                                emailIntent .putExtra(Intent.EXTRA_SUBJECT,"Öğrenci Bilgiler Dışa Aktarıldı");
