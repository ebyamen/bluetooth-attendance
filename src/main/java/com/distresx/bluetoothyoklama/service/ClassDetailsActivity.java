...
import com.distresx.bluetoothyoklama.fragments.ClassDetailsMainFragment;
import com.distresx.bluetoothyoklama.fragments.GraphFragment;
import com.distresx.bluetoothyoklama.fragments.StudentAttendanceFragment;
import com.distresx.bluetoothyoklama.fragments.StudentListFragment;
...
public class ClassDetailsActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    private void initToolbar()
    {
        ...
        batchNameToolbar.setText(subName);
        batchSubjectToolbar.setText(subCode);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        switch (item.getItemId())
        {
            case R.id.delete_menu:
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
                builder.setMessage("Sınıfı Silmek İstiyor Musunuz?")
                        .setCancelable(false)
