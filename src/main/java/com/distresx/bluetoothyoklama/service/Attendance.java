...
import com.distresx.bluetoothyoklama.adapters.ListViewAdapter;
...
public class Attendance extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        for(int i = 0 ; i < numBatch ; i++)
            ObjectItemData[i] = new ObjectItem(allBatch.get(i).getBatchID(),allBatch.get(i).getSubject(),allBatch.get(i).getSubjectCode(),allBatch.get(i).getBatch(),1,"-","-","-");
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Sınıf Listesi");
