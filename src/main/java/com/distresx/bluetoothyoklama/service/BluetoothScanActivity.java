...
public class BluetoothScanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Toast.makeText(getApplicationContext(),"Cihazınızda Bluetooth Bulunamadı!",Toast.LENGTH_SHORT).show();
            finish();
        }
        else
        {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        {
            Toast.makeText(getApplicationContext(),"Lütfen Bluetooth'u Açın!", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
